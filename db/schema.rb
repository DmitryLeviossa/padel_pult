...
ActiveRecord::Schema[8.0].define(version: 2026_07_08_103332) do
  ...
  create_table "pairs", force: :cascade do |t|
    ...
    t.boolean "player1_count_score", default: true, null: false
    t.boolean "player2_count_score", default: true, null: false
  ...
  create_table "tournaments", force: :cascade do |t|
    ...
    t.string "ranking_method", default: "score_delta", null: false
